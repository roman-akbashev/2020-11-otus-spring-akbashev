...
public class DataBaseChangelog {
    ...
    public void users(UserRepository userRepository) {
        userRepository.save(User.builder().name("user").password("user").role("ROLE_USER").build());
        userRepository.save(User.builder().name("admin").password("admin").role("ROLE_ADMIN").build());
    }
}
