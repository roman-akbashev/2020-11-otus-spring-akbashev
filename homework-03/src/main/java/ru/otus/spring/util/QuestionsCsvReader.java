...
public class QuestionsCsvReader implements QuestionReader {
    ...
    @Autowired
    public QuestionsCsvReader(AppProperties appProperties, ResourcesProperties resourcesProperties) {
        String resourceName = resourcesProperties.getCsvFileName().replaceFirst("@locale", appProperties.getLocale().toString());
        this.questionsResource = new ClassPathResource(resourceName);
        this.resourceName = resourceName;
    }

    public QuestionsCsvReader(String resourceName) {
        this.questionsResource = new ClassPathResource(resourceName);
        this.resourceName = resourceName;
    }
